 ...
 * <code>org.eclipse.jdt.internal.ui.text.JavaBreakIterator</code>.
 */
/*
...
public class CommonBreakIterator extends BreakIterator {
    ...
    protected static class LineDelimiter extends Run {
        ...
        /*
         * @see
         * org.eclipse.xtext.ui.editor.model.CommonBreakIterator.Run#consume
         * (char)
         */
        @Override
        protected boolean consume(char ch) {
    ...
    protected static class Identifier extends Run {
        /*
         * @see
         * org.eclipse.xtext.ui.editor.model.CommonBreakIterator.Run#isValid
         * (char)
         */
        @Override
        protected boolean isValid(char ch) {
    ...
    protected static class CamelCaseIdentifier extends Run {
        ...
        /*
         * @see
         * org.eclipse.xtext.ui.editor.model.CommonBreakIterator.Run#consumes
         * (char)
         */
        @Override
        protected boolean consume(char ch) {
